	...
	<div id="MainBodyCentered">
        ...
        <div id="BodyContent">
            ...
            <div id="RightBodyContent">
                <img src="<?php print $app_data['asset-sever']; ?>bcms/templates/gcwd/images/MainBody-Picture.jpg" alt="gold coast web design development" width="282" height="173" align="left" />
		...
		<div id="FooterHolder">
        	<div id="FooterMenu">
                ...
                <a href="http://creativeweblogic.net/">Copyright &copy; Creative Web Logic.Net</a></div>
