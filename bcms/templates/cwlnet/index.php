...
<link href="<?php print $app_data['asset-sever']; ?>bcms/templates/cwlnet/css/general.css" rel="stylesheet" type="text/css" />
</head>
    ...
    <div id="MainBodyCentered">
        ...
        <div id="BodyContent">
            ...
            <div id="RightBodyContent">
                <img src="<?php print $app_data['asset-sever']; ?>bcms/templates/cwlnet/images/MainBody-Picture.jpg" alt="gold coast web design development" width="282" height="173" align="left" />
		...
		<div id="FooterHolder">
        	<div id="FooterMenu">
                ...
                <div id="FooterMenuRight"><a href="http://creativeweblogic.info/">Copyright &copy; Creative Web Logic.Net</a></div>
