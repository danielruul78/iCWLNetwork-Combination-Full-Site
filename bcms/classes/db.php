<?php
    ...
    */
    if($DB['server_type']=="MySQL"){
        ...
        $DB['current_dir']="/home2/icwl0738/iCWLNet_Application_Code/ICWLNet_Full_Website_Builder/";
        $DB['server_number']=1;
        $DB['hostname']="localhost";
        $DB['usernamedb']='icwl0738_bubblelite_Code';
        $DB['passworddb']='DickSux5841*';
        $DB['dbName']='icwl0738_bubblelite_Code';
