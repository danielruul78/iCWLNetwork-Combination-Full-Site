<?php
	...
	class clsRetrieveRecords extends clsRetrieveRecordsDesigner{
		var $SQL;
		var $Table;
		var $TargetField="id";
		var $SearchVar;
		...
		public function CreateDB(){
			...
			//try{
				...
				$this->m = new clsRetrieveRecordsConnect();
	...
	class clsBulkDBChange extends clsRetrieveRecordsDesigner{
		var $Table;
	...
	class clsDeleteFromDatabase extends clsRetrieveRecordsDesigner{
		var $Table;
		var $RecordArray=array();
		var $WhatToDelete="id";
		var $Errors;
	...
	class clsAddToDatabase extends clsRetrieveRecordsDesigner{
		var $SQL;
		var $SQLFields;
		var $SQLData;
		var $Table;
	...
	class clsUpdateDatabase extends clsRetrieveRecordsDesigner{
		var $SQL;
		var $SQLData;
		var $Table;
		var $ID;
	...
	//-----------------------------------------------------------------------------------------------------------
	class clsRetrieveRecordsConnect extends clsRetrieveRecordsDesigner{
		public $log=false;
		var $log_text="";
		var $links = array();
		var $connect=array();
