...
--
-- Name: approved_new_rejected_type; Type: TYPE; Schema: public; Owner: ebvehfij
--

CREATE TYPE public.approved_new_rejected_type AS ENUM (
    'Approved',
    'New',
    'Rejected'
);
...
ALTER TYPE public.approved_new_rejected_type OWNER TO ebvehfij;

--
-- Name: headline_article_archive_type; Type: TYPE; Schema: public; Owner: ebvehfij
--

CREATE TYPE public.headline_article_archive_type AS ENUM (
    'Headline',
    'Article',
    'Archive'
);
...
ALTER TYPE public.headline_article_archive_type OWNER TO ebvehfij;

--
-- Name: public_member_both_type; Type: TYPE; Schema: public; Owner: ebvehfij
--

CREATE TYPE public.public_member_both_type AS ENUM (
    'Public',
    'Member',
    'Both'
);
...
ALTER TYPE public.public_member_both_type OWNER TO ebvehfij;

--
-- Name: yes_no_type; Type: TYPE; Schema: public; Owner: ebvehfij
--
...
ALTER TYPE public.yes_no_type OWNER TO icwlnet;
...
--
-- Name: administrators; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
CREATE TABLE public.administrators (
    ...
    administratoractive integer DEFAULT 0 NOT NULL,
    su public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL,
    clientsid integer DEFAULT 1 NOT NULL,
    hash character varying(111) NOT NULL
);


ALTER TABLE public.administrators OWNER TO ebvehfij;

--
-- Name: administrators_id_seq; Type: SEQUENCE; Schema: public; Owner: ebvehfij
--
...
ALTER TABLE public.administrators_id_seq OWNER TO ebvehfij;

--
-- Name: administrators_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ebvehfij
--
...
--
-- Name: clients; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
ALTER TABLE public.clients OWNER TO ebvehfij;

--
-- Name: content_pages; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.content_pages (
    id integer NOT NULL,
    uri character varying(100) DEFAULT ''::character varying NOT NULL,
    menutitle character varying(100) DEFAULT ''::character varying NOT NULL,
    languagesid integer DEFAULT 1 NOT NULL,
    changed timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    domainsid integer NOT NULL,
    templatesid integer DEFAULT 0 NOT NULL,
    module_viewsid integer DEFAULT 1 NOT NULL,
    meta_keywords text NOT NULL,
    meta_description text NOT NULL,
    meta_title text NOT NULL,
    exposure public.public_member_both_type DEFAULT 'Both'::public.public_member_both_type NOT NULL,
    menu_hide public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL,
    homepage public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL,
    sort_order integer DEFAULT 0,
    "Title" character varying(100) NOT NULL COLLATE pg_catalog."en-AU-x-icu"
);


ALTER TABLE public.content_pages OWNER TO ebvehfij;

--
-- Name: countries; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.countries (
    id integer NOT NULL,
    country_code character varying(2) NOT NULL,
    country_name character varying(111) NOT NULL
);


ALTER TABLE public.countries OWNER TO ebvehfij;

--
-- Name: domains; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
CREATE TABLE public.domains (
    ...
    gsitemapmeta character varying(200) NOT NULL,
    sitetitle character varying(50) DEFAULT NULL::character varying,
    clientsid integer DEFAULT 1 NOT NULL,
    aemail character varying(50) DEFAULT 'danielruul78@gmail.com'::character varying NOT NULL,
    templatesid integer DEFAULT 1 NOT NULL,
    serversid integer NOT NULL,
    mirrorid integer DEFAULT 0 NOT NULL,
    public public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL,
    "SEOFriendly" public.yes_no_type DEFAULT 'Yes'::public.yes_no_type NOT NULL
);


ALTER TABLE public.domains OWNER TO ebvehfij;

--
-- Name: domains_modules; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.domains_modules (
    id integer NOT NULL,
    domainsid integer NOT NULL,
...
ALTER TABLE public.domains_modules OWNER TO ebvehfij;

--
-- Name: languages; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
ALTER TABLE public.languages OWNER TO ebvehfij;

--
-- Name: mod_business_categories; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.mod_business_categories (
    id integer NOT NULL,
    categorytitle character varying(100) NOT NULL,
    subdomain character varying(100) NOT NULL,
    domainsid integer NOT NULL
);


ALTER TABLE public.mod_business_categories OWNER TO ebvehfij;

--
-- Name: mod_news; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.mod_news (
    id integer NOT NULL,
    content_pagesid integer NOT NULL,
    content_text text NOT NULL,
    image character varying(100) NOT NULL,
    ntype public.public_member_both_type DEFAULT 'Public'::public.public_member_both_type,
    usersid integer DEFAULT 0 NOT NULL,
    approved public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL,
    sorder integer DEFAULT 0 NOT NULL,
    mntype public.headline_article_archive_type DEFAULT 'Article'::public.headline_article_archive_type NOT NULL,
    description character varying(150) NOT NULL
);


ALTER TABLE public.mod_news OWNER TO ebvehfij;

--
-- Name: mod_text; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.mod_text (
    id integer NOT NULL,
    content_pagesid integer NOT NULL,
    content_text text NOT NULL,
    sidebar_content public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL
);


ALTER TABLE public.mod_text OWNER TO ebvehfij;

--
-- Name: module_views; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.module_views (
    id integer NOT NULL,
    modulesid integer NOT NULL,
    pre_filename character varying(50) NOT NULL,
    filename character varying(50) NOT NULL,
    viewname character varying(50) NOT NULL
);


ALTER TABLE public.module_views OWNER TO ebvehfij;

--
-- Name: module_views_menu; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.module_views_menu (
    module_viewsid integer NOT NULL,
    exposure public.public_member_both_type DEFAULT 'Public'::public.public_member_both_type NOT NULL
);


ALTER TABLE public.module_views_menu OWNER TO ebvehfij;

--
-- Name: modules; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
CREATE TABLE public.modules (
    ...
    optional public.yes_no_type DEFAULT 'Yes'::public.yes_no_type NOT NULL
);


ALTER TABLE public.modules OWNER TO ebvehfij;

--
-- Name: servers; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.servers (
    id integer NOT NULL,
    name character varying(30) NOT NULL,
    main_url character varying(100) NOT NULL,
    clientsid integer NOT NULL,
    servername character varying(50) NOT NULL,
    serveradmin character varying(255) NOT NULL,
    ip_hostname character varying(200) NOT NULL
);


ALTER TABLE public.servers OWNER TO ebvehfij;

--
-- Name: servers_databases; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.servers_databases (
    id integer NOT NULL,
    serversid integer NOT NULL,
...
ALTER TABLE public.servers_databases OWNER TO ebvehfij;

--
-- Name: siteuserclient; Type: TABLE; Schema: public; Owner: ebvehfij
--

CREATE TABLE public.siteuserclient (
    id integer NOT NULL,
    timenow timestamp(6) without time zone NOT NULL,
    guid character varying(32) NOT NULL,
    domainsid integer NOT NULL
);


ALTER TABLE public.siteuserclient OWNER TO ebvehfij;

--
-- Name: templates; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
CREATE TABLE public.templates (
    ...
    name character varying(100) NOT NULL,
    dir character varying(100) NOT NULL,
    hidden public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL,
    allow_sidebar public.yes_no_type DEFAULT 'No'::public.yes_no_type NOT NULL
);


ALTER TABLE public.templates OWNER TO ebvehfij;

--
-- Name: users; Type: TABLE; Schema: public; Owner: ebvehfij
--
...
CREATE TABLE public.users (
    ...
    address2 character varying(111) NOT NULL,
    address3 character varying(111) NOT NULL,
    suburb character varying(30) DEFAULT ''::character varying,
    city character varying(111) NOT NULL,
    state character varying(20) DEFAULT ''::character varying,
    postcode integer DEFAULT 0,
    countryid integer NOT NULL,
    subdomain character varying(50) DEFAULT ''::character varying,
    phone character varying(30) DEFAULT ''::character varying,
    mobile character varying(30) DEFAULT ''::character varying,
    fax character varying(30) DEFAULT ''::character varying,
    email character varying(50) DEFAULT ''::character varying,
    website character varying(80) DEFAULT ''::character varying,
    contact_name character varying(30) DEFAULT ''::character varying,
    ...
    abn character varying(15) DEFAULT ''::character varying,
    business_description text,
    mod_business_categoriesid integer NOT NULL,
    status public.approved_new_rejected_type DEFAULT 'New'::public.approved_new_rejected_type NOT NULL,
    clientsid integer DEFAULT 0 NOT NULL
);


ALTER TABLE public.users OWNER TO ebvehfij;

--
-- Name: administrators id; Type: DEFAULT; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: administrators; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--


--
-- Data for Name: clients; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--



--
-- Data for Name: content_pages; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: countries; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: domains; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--



--
-- Data for Name: domains_modules; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: languages; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: mod_business_categories; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: mod_news; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--


--
-- Data for Name: mod_text; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: module_views; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: module_views_menu; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--


--
-- Data for Name: modules; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: servers; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--



--
-- Data for Name: servers_databases; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--



--
-- Data for Name: siteuserclient; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--



--
-- Data for Name: templates; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: ebvehfij
--


--
-- Name: administrators_id_seq; Type: SEQUENCE SET; Schema: public; Owner: ebvehfij
--


--
-- Name: administrators administrators_pkey; Type: CONSTRAINT; Schema: public; Owner: ebvehfij
--
...
--
-- Name: clients clients_pkey; Type: CONSTRAINT; Schema: public; Owner: ebvehfij
--
...
--
-- ebvehfijQL database dump complete
--
