...
function GetControlString()
{
    ...
    if ($g_arrBrowser['has_htmledit'])
    {
        ...
        if (strlen($this->m_dwFlags)) $str .= "obj.lFlags = " . $this->m_dwFlags . "\n";
        ...
        if ($this->m_strCssUrl) $str .= "obj.strCssStyle = " . $this->QuotePhpStr($this->m_strCssUrl) . "\n";
...
function HtmlEditGetBrowser()
{
    ...
    else if (ereg("Safari", $arr['useragent']))
    {
        $arr['browser'] = "Safari";
