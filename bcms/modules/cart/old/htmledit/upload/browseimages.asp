...
const uploadsDirVar = "e:\htdocs\htmledit\upload\images\"

' URL to access the image directory. must provide trailing slash
const imagediruri = "http://localhost:81/htmledit/upload/images/"
...
<%
	...
	For Each f1 in fc
		...
		%><td width="<% =lColWidth %>" align=center><a href="#" onclick="javascript: MyDlgHandleOK('<% = imagediruri & f1.name%>')"><%
			if bUseThumbnail then 
