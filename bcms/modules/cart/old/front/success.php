  ...
  <tr>
    <td height="274" colspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <p align="left">Thank you for purchasing TOHO 9000, your products will be shipped to you shortly.</p>             <!--START Partners Pro CODE-->

<img src="http://www.partnerspro.biz/trackingcode_sale.php?mid=4&sec_id=M_43hT6fO8sU9nC&sale=<?=$_GET['Amount']?>&orderId=<?=$_GET['InvoiceID']?>" height="1" width="1" alt=""> 

<!-- END Partners Pro CODE -->
            </td>
          </tr>
          <tr>
