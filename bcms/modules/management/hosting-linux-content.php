          ...
          <td align="center" ><table width="100%"  border="0" cellspacing="0" cellpadding="10">
              <tr>
                ...
                Shared Accounts - Linux<br>
                  <div style="float:left;padding:20px">
                  Tiny <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                  AUD$1.00 /mo<br> 
                  1GB of Web Space<br> 
                  ...
                  <div style="float:left;padding:20px">
                  Basic <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                  AUD$2.00 /mo<br> 
                  2GB of Web Space<br> 
                  ...
                  <div style="float:left;padding:20px">
                  Business <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                  AUD$4.00 /mo<br> 
                  4GB of Web Space<br> 
                  ...
                  <div style="float:left;padding:20px">
                  Corporate <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                  AUD$8.00 /mo<br> 
                  8GB of Web Space<br> 
                ...
                <div style="float:left;padding:20px">
                Biz <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                AUD$10.00 /mo<br> 
                ...
                Unlimited Sub Domains<br>
                  ...
                  <div style="float:left;padding:20px">
                  Super <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                  AUD$15.00 /mo<br> 
                  ...
                  <div style="float:left;padding:20px">
                  Amazing <a href="/hosting-linux-control-cpanel.php">CPanel</a><br><br> 
                  AUD$20.00 /mo<br> 
